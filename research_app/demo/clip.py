...
The app integration is done at `research_app/components/model.py`.
"""
import enum
import logging
import os.path
...
_HTTP_POSTER_ASSETS = "https://github.com/aniketmaurya/temp-poster-assets/blob/main/"


def download_files():
    print("Downloading embeddings, this might take some time!")
    urllib.request.urlretrieve(_HTTP_POSTER_ASSETS + "embeddings.npy?raw=true", "resources/embeddings.npy")
    urllib.request.urlretrieve(_HTTP_POSTER_ASSETS + "embeddings2.npy?raw=true", "resources/embeddings2.npy")
    urllib.request.urlretrieve(_HTTP_POSTER_ASSETS + "data.csv?raw=true", "resources/data.csv")
    urllib.request.urlretrieve(
        "https://drive.google.com/uc?export=download&id=19aVnFBY-Rc0-3VErF_C7PojmWpBsb5wk", "resources/data2.csv"
    )
